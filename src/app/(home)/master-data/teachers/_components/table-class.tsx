...
export default function TableTeachers({
  ...
  model: ReturnType<typeof useTeachersViewModel>;
}) {
  return (
        ...
        <Table>
          <TableHeader className="bg-gray-50">
            <TableRow className="text-left text-base  text-[#667085] capitalize">
              ...
              <TableHead className="px-4 py-3  font-semibold">Nik</TableHead>
          ...
          <TableBody>
            {model.values.teachers.data.map((item: TTeacher, index) => (
